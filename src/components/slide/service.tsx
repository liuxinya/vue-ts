...
import {ClickBlock} from './click-block/index';
import {Modal} from './index';
const createElement = (marker : string, root
    ?, tag
    ?) => {
...
class ModalManager {
    private modals : any = {};
    fromComponent(com : any, options : ModalOption) {
...
let ModalManagerInstance = new ModalManager();
